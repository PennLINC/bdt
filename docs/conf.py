# bdt documentation build configuration file, created by
...
# -----------------------------------------------------------------------------
bibtex_bibfiles = ['../src/bdt/data/boilerplate.bib']
bibtex_style = 'unsrt'
...
latex_documents = [
    (master_doc, 'bdt.tex', 'BDT Documentation', author, 'manual'),
]
...
man_pages = [(master_doc, 'BDT', 'BDT Documentation', [author], 1)]
...
linkcode_resolve = make_linkcode_resolve(
    'bdt',
    'https://github.com/nipreps/BDT/blob/{revision}/{package}/{path}#L{lineno}',
)
