...
.. warning::
   *BDT* requires preprocessing outputs in MNI152NLin6Asym space with
...
The *BDT* workflow takes as principal input the path of the dataset
...
The exact command to run *BDT* depends on the Installation_ method.
The common parts of the command follow the `BIDS-Apps
<https://github.com/BIDS-Apps>`_ definition.
Example: ::

    bdt data/bids_root/ out/ participant -w work/
...
``<output dir>/bdt/sub-<participant_label>/log`` directory.
