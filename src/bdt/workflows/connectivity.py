...
def init_functional_connectivity_nifti_wf(
    ...
    Workflow Graph
        .. workflow::
            ...
            from bdt.tests.tests import mock_config
            from bdt import config
            from bdt.workflows.bold.connectivity import init_functional_connectivity_nifti_wf
    ...
    coverage : :obj:`str`
    timeseries : :obj:`str`
    correlations : :obj:`str`
    correlations_exact : :obj:`str`
    parcellated_alff
    parcellated_reho
    """
    from bdt.interfaces.connectivity import ConnectPlot, NiftiParcellate, TSVConnect
...
def init_functional_connectivity_cifti_wf(
    ...
    Workflow Graph
        .. workflow::
            ...
            from bdt import config
            from bdt.tests.tests import mock_config
            from bdt.workflows.bold.connectivity import init_functional_connectivity_cifti_wf
    ...
    Outputs
    -------
    coverage_ciftis : :obj:`list`
    timeseries_ciftis : :obj:`list`
    correlation_ciftis : :obj:`list`
    ...
    from bdt.interfaces.connectivity import CiftiToTSV, ConnectPlot
    from bdt.interfaces.plotting import PlotCiftiParcellation
