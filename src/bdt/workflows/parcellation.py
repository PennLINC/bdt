...
def init_load_atlases_wf(name='load_atlases_wf'):
    ...
    atlas_labels_files
    """
    from bdt.interfaces.bids import CopyAtlas, CopyAtlasDescription
    from bdt.utils.atlas import collect_atlases
    from bdt.utils.boilerplate import describe_atlases
...
def init_parcellate_cifti_wf(
    ...
    """
    from bdt.interfaces.connectivity import CiftiMask, CiftiToTSV, CiftiVertexMask
    from bdt.interfaces.workbench import CiftiMath, CiftiParcellateWorkbench
