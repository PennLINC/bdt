...
def init_single_subject_wf(subject_id: str):
    ...
    from bdt.utils.bids import collect_derivatives
...
performed using *BDT* {config.environment.version},
...
to workflows in *BDT*'s documentation]\
(https://bdt.readthedocs.io/en/latest/workflows.html).


### Copyright Waiver

The above boilerplate text was automatically generated by BDT
...
def init_single_run_wf(bold_file):
    """Set up a single-run workflow for BDT."""
    from niworkflows.engine.workflows import LiterateWorkflow as Workflow

    from bdt.utils.bids import collect_derivatives, extract_entities
